  ...
  return (
    <article>
      ...
      >
        ...
        <span className="absolute inset-0 flex items-center justify-center px-4 text-center text-[32px] font-bold uppercase tracking-[0.24em] text-white md:text-[40px]">
          Editorial
        </span>
      </Link>
    </article>
