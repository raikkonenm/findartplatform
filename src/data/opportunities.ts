...
export const OPPORTUNITIES: Opportunity[] = [
  {
    ...
    sections: [
      ...
      { title: "Support", items: ["A stipend of в‚¬1,000 per month", "Travel reimbursement at the start of the residency", "A furnished apartment and Deutschlandticket", "Possible coverage of production costs", "Museum access and support from the DAS MINSK team"] },
  ...
  },
  {
    ...
    intro: [
      ...
      "Proposals should respond to CTM 2027's theme ProcessвЂ¦ing and be developed for two complementary formats: a live event at CTM Festival and a radio work for Deutschlandfunk Kultur and ORF. Sound must be the principal medium.",
    ],
    sections: [
      { title: "Presentation", items: ["Premiere at CTM 2027 in Berlin, 22вЂ“31 January 2027", "A 40вЂ“55 minute Deutschlandfunk Kultur radio work in spring 2027", "Presentation through ORF and/or musikprotokoll in autumn 2027", "Live work designed for an intimate 6.1-channel listening setup at silent green Kuppelhalle"] },
      { title: "Support", items: ["Two commissions of в‚¬6,000 each", "Technical and staging costs covered upon discussion", "Travel to Berlin and accommodation during production and festival periods", "Production guidance from CTM, Deutschlandfunk Kultur, and ORF"] },
  ...
  },
  {
    ...
    rewards: ["Accommodation", "Funding", "Production", "Travel"],
    rewardSummary: "в‚¬1,500 fee + в‚¬3,500 production",
    applicationFee: "FREE",
    tags: ["SOUND ART", "INSTALLATION", "PUBLIC ART", "CLIMATE", "LISTENING"],
    intro: [
      "Atmospheric Waves is an art festival of wind, climate and listening held in LiepДЃja, Latvia, as part of LiepДЃja вЂ” European Capital of Culture 2027. The open call invites original concepts for sound-art works that respond to the wind and climate conditions of the western Latvian coast.",
      "The exhibition takes the form of five selected installations and/or interactive digital artworks, on view from 15 May вЂ” 30 November 2027 at the former KURSA factory grounds and the newly reopened club house.",
    ],
    sections: [
      { title: "Support", items: ["Production budget up to в‚¬3,500 per project (including technical set-up and transportation)", "Artist fee of в‚¬1,500 per project", "Production residency with accommodation at Laidi Palace, 5 April вЂ” 12 May 2027"] },
      { title: "Timeline", items: ["Festival: 12 вЂ“ 16 May 2027", "Exhibition: 15 May вЂ” 30 November 2027", "Application deadline: 4 September 2026"] },
  ...
  },
  {
    ...
    title: "OASIs 2026 вЂ” International Residency",
    ...
    rewards: ["Accommodation", "Funding", "Production", "Travel"],
    rewardSummary: "в‚¬1,300 fee + в‚¬600 production",
    applicationFee: "FREE",
    ...
    sections: [
      { title: "Support", items: ["Artist fee of в‚¬1,300 (gross, tax status dependent)", "Production budget up to в‚¬600 (materials, technical services, tools)", "Travel grant (lump sum, distance-based, with top-ups for green travel)", "в‚¬45 per diem", "Accommodation in a self-catering hotel"] },
      { title: "Residency periods", items: ["Residency 1: 9 вЂ“ 22 November", "Residency 2: 16 вЂ“ 29 November", "Residency 3: 23 November вЂ” 6 December", "Residency 4: 30 November вЂ” 13 December", "Residency 5: 7 вЂ“ 20 December"] },
  ...
  },
  {
    ...
    sections: [
      { title: "Exhibition", items: ["Exhibition dates: 7 вЂ“ 25 April 2027 (subject to change)", "Digital works printed on A3 (297 Г— 420 mm) foam board and installed by CICA curators", "Physical prints / installations: artists cover shipping to and from CICA; 2D works в‰¤ 1 m longest side, installations в‰¤ 1 Г— 1 Г— 2 m, wall-mounted в‰¤ 10 kg"] },
      { title: "How to submit", items: ["Send up to 3 direct video links and/or up to 5 JPG images (100вЂ“500 KB recommended) with a short bio to submission@cicamuseum.com", "Subject line: 'Submission: Photography Now 2027 вЂ“ Artist's Name'", "Submission deadline: 20 August 2026"] },
  ...
  },
  {
    ...
    title: "Bring Your Art to Paris вЂ” September 2026",
    deadline: "20 August 2026",
    deadlineDate: "2026-08-20",
    ...
    intro: [
      ...
      "The call is open across disciplines вЂ” from painting and sculpture to photography, digital, installation and interdisciplinary practices.",
    ],
    sections: [
  ...
  },
  {
    ...
    intro: [
      "Performing Arts Camp in Koenji (PACK) is a two-week art camp for young artists based in Asia, held at ZA-KOENJI Public Theatre in Tokyo from 6 вЂ“ 20 December 2026.",
    ...
    sections: [
      { title: "Support", items: ["Accommodation at ZA-KOENJI Public Theatre for ~2 weeks", "Per diem for on-site camp period (2,400 JPY Г— 15 days)", "Event insurance", "Party and research fees up to 15,000 JPY", "For participants outside Japan: round-trip flights + airport shuttle", "For participants outside the KantЕЌ region: round-trip transportation from residence to Tokyo"] },
      { title: "Programme", items: ["Two weeks in Tokyo, 6 вЂ“ 20 December 2026", "Lectures, discussions and research using the theatre and the Koenji neighbourhood as fields of exploration", "Collective 'party' presenting findings at the end"] },
  ...
  },
  {
    ...
    title: "Sevenoaks Open Call вЂ” Studio & Project Spaces",
    ...
    intro: [
      ...
      "The site will be awarded free of charge. In return, awarded groups organise some public-facing events alongside their use вЂ” workshops, talks or anything that supports their creative practice.",
    ],
    sections: [
  ...
  },
  {
    ...
    rewardSummary: "ВЈ15,000 вЂ“ ВЈ40,000",
    applicationFee: "FREE",
    tags: ["AWARD", "DISABILITY", "COMMISSION", "UK"],
    intro: [
      "Unlimited's Partner Awards help disabled artists bring ambitious new work to life. This year 11 awards totalling ВЈ280,000 are offered across England, Scotland and Wales, funded by Arts Council England, Arts Council of Wales and the National Lottery through Creative Scotland.",
      "Awards range from ВЈ15,000 to ВЈ40,000. Full details, criteria and application guidance are available on each partner award's individual page, in audio, BSL, Easy Read, large print, Scottish Gaelic and Welsh where applicable.",
    ],
    sections: [
  ...
  },
  {
    ...
    organizer: "Espace Brownstone Г— Art in Latin America",
    ...
    intro: [
      "Association Noemi вЂ” Espace Brownstone (formerly Fondation Brownstone) and Art in Latin America open a call for artists from Latin America and the Caribbean to spend two and a half months at Espace Brownstone in Paris (15 January вЂ” 31 March 2027).",
  ...
  },
  {
    ...
    organizer: "THE TAGLI Г— Rosewood London",
    ...
    rewardSummary: "ВЈ2,000 + year-long mentorship",
    applicationFee: "FREE",
    ...
    intro: [
      ...
      "The exhibition is part of Rosewood London's Living Gallery вЂ” a rotating residency programme spotlighting emerging contemporary artists connected to London вЂ” and shows alongside two shortlisted nominees.",
    ],
    sections: [
      { title: "Winner receives", items: ["Year-long mentorship with THE TAGLI team (regular meetings, career coaching, market guidance)", "Inclusion in the Living Gallery group residency exhibition at Rosewood London", "ВЈ2,000 bursary provided by Rosewood"] },
      { title: "Shortlisted nominees", items: ["Two shortlisted nominees have their work included alongside the winner in the same exhibition", "Each shortlisted nominee receives a ВЈ500 bursary from Rosewood"] },
  ...
  },
  {
    ...
    title: "Shelter вЂ” Group Exhibition",
    ...
    applicationFee: "ВЈ150 / piece",
    tags: ["OPEN CALL", "GROUP SHOW", "LONDON", "EXHIBITION"],
    intro: [
      "Shelter is a group exhibition at 15 Bermondsey Square, Central London (31 October вЂ” 4 November 2026), curated by Monica Mardare. It asks artists to locate their own shelter вЂ” the person, place, body, boundary, ritual, memory or community that protects them вЂ” and what that protection costs.",
    ...
    sections: [
      ...
      { title: "Fees & sales", items: ["Participation fee: ВЈ150 per piece (physical, digital, 3D). Plinth on request, additional cost", "Larger / installation-based works: fee adjusted on discussion", "All submitted artworks should be for sale; 20% commission, 80% to the artist", "Payment due within 7 days of acceptance; non-refundable"] },
  ...
  },
  {
    ...
    title: "Neo Future вЂ” Shifting into New Realities",
    deadline: "3 September 2026",
    deadlineDate: "2026-09-03",
    location: "HГ¤meenkyrГ¶, Finland",
    ...
    intro: [
      "Neo Future is a two-week thematic residency at Arteles Creative Center (3 вЂ“ 18 December 2026) for people reaching beyond the familiar and investigating what may emerge next вЂ” AI, expanded consciousness, human transformation, singularity, future societies and realities not yet named.",
    ...
    sections: [
      ...
      { title: "Programme fees (no application fee)", items: ["Financially supported fee: в‚¬1,050 (limited numbers)", "Regular fee: в‚¬1,450", "Contributor fee: в‚¬1,850 (voluntary contribution)", "Supporter fee: в‚¬2,250 (larger voluntary contribution)", "Registration fee в‚¬120 (non-refundable, only paid if selected)"] },
  ...
  },
  {
    ...
    title: "Communal Autumn/Winter вЂ” 'Form'",
    deadline: "6 September 2026",
    deadlineDate: "2026-09-06",
    ...
    intro: [
      "Aspex Portsmouth invites proposals to use its Communal Space free of charge during the Autumn/Winter 2026 season, as part of the ongoing Communal programme. This season's theme is 'Form' вЂ” what it means to begin to exist as artists or communities, to form impressions, to make or become something, and how separate elements come together to create a whole.",
  ...
  },
  {
    ...
    title: "Teatri Riflessi 2027 вЂ” Short Performance Competition",
    deadline: "15 October 2026",
    deadlineDate: "2026-10-15",
    ...
    rewardSummary: "в‚¬500 вЂ“ в‚¬1,200 prizes + fees",
    applicationFee: "FREE",
    tags: ["AWARD", "PERFORMANCE", "FESTIVAL", "SICILY"],
    intro: [
      "Teatri Riflessi is an international competition for short live performances (max 15 minutes) held in Zafferana Etnea, Sicily, from 16 вЂ“ 19 July 2027. Now in its 12th edition, the festival promotes discussion on dramaturgy and contemporary performing languages, connecting the stage to the representation of the territory and back again.",
      "The 2027 theme, Constellations, evokes a living web of invisible bonds вЂ” a network of relationships that precedes us and connects us to others and the landscapes we inhabit. Around 10 short performances will be selected via open call.",
    ],
    sections: [
      { title: "Fees and awards", items: ["Selected performances receive в‚¬500 вЂ“ в‚¬1,100 (VAT included) depending on cast size", "Possible travel contribution up to в‚¬250 (subject to funding, origin, cast size)", "Main awards include Best Performance в‚¬1,200; Best Dramaturgy в‚¬500; Best Direction в‚¬500; Best Performer в‚¬500; Scholars' & Critics' в‚¬500; Youth Jury в‚¬300; plus special partner awards"] },
      { title: "Application", items: ["Free to apply; в‚¬50 refundable deposit only if selected", "Complete dramaturgy or research doc + full performance video (excerpts insufficient)", "Foreign-language works accepted (Italian + English surtitles provided)", "Deadline: 15 October 2026, 17:00 CET"] },
      { title: "Presentation", items: ["Rehearsals 13 вЂ“ 14 July 2027; semi-finals 15 вЂ“ 16 July; final 18 July", "Attendance required through 23:30 on Sunday 18 July 2027"] },
    ],
  ...
  },
  {
    ...
    audience: "Visual artists born in Hesse, or resident there since в‰¤ 1 Jan 2025, or having completed a degree at a Hesse art academy or comparable programme",
    ...
    rewardSummary: "в‚¬12,500 вЂ“ в‚¬25,000 grants",
    applicationFee: "FREE",
    tags: ["GRANT", "RESIDENCY", "HESSE", "INTERNATIONAL"],
    intro: [
      "The Hessische Kulturstiftung awards 5 travel grants (3 вЂ“ 12 months) and 9 residency / combined grants for 2027/2028: New York City, London and Paris (12 months), Istanbul (6 months), and Kyoto (3 months residency at Villa Kamogawa + 3 months travel). Artist duos may submit a joint application, with no age limit.",
      "For the production of works developed within the grant or their presentation in exhibitions or publications, an additional в‚¬7,700 is available for up to three years after the grant period.",
    ],
    sections: [
      { title: "Grants offered", items: ["5 travel grants (в‚¬25,000 each) 2027/2028", "2027: 1 NYC, 1 Paris, 2 Istanbul, 1 Kyoto + Japan travel", "2028: 1 NYC, 1 Paris, 1 London, 1 Kyoto + Japan travel", "Additional up to в‚¬7,700 for production / presentation"] },
      { title: "Eligibility", items: ["Born in Hesse, or primary Hesse residence since в‰¤ 1 Jan 2025, or completed studies at a Hesse art academy", "No age limit; duos may apply jointly", "Previous Hessische Kulturstiftung travel / residency grantees not eligible", "Not currently in a degree or vocational programme"] },
  ...
  },
  {
    ...
    title: "The Perch вЂ” 'The Mix' Open Call",
    ...
    intro: [
      "The Perch, a peer-reviewed creative arts journal produced by the Yale Program for Recovery and Community Health, opens submissions for its next issue вЂ” The Mix вЂ” launching October 2027. The theme refers to the double-sided nature of mental illness and mental health: the highs and lows, the joys and sorrows, and the brilliant things that can derive from the experience.",
    ...
    sections: [
      { title: "What to submit", items: ["Poetry, creative nonfiction, fiction, artwork, visual art or scholarly pieces", "Personal stories especially welcomed", "Peer-reviewed open call вЂ” all are welcome to submit"] },
  ...
  },
  {
    ...
    organizer: "The Photographers' Gallery Г— The Ampersand Foundation",
    title: "Cite the Past, Sight the Stars вЂ” Residency",
    deadline: "6 September 2026",
    deadlineDate: "2026-09-06",
    ...
    rewardSummary: "ВЈ3,500 + accommodation + studio",
    applicationFee: "FREE",
    ...
    sections: [
      { title: "What the residency offers", items: ["Two months' accommodation and studio space at Wigwell Lodge, Derbyshire", "ВЈ1,000 stipend per month", "ВЈ1,000 production budget", "Up to ВЈ500 towards travel", "Curatorial and administrative support from The Photographers' Gallery", "Public presentation or showcase at The Photographers' Gallery or a partner venue"] },
  ...
  },
  {
    ...
    title: "WRG Digital Call-Out вЂ” Generation Xi",
    ...
    intro: [
      "The White Rabbit Gallery Digital Call-Out invites emerging artists and designers to respond to the current gallery exhibition theme вЂ” Generation Xi вЂ” with an animation / artwork for the WRG website landing page. The winning artwork is showcased on the landing page 24/7 for 5 months, promoted across WRG social channels, and permanently archived in the WRG Digital Archive.",
    ...
    sections: [
      ...
      { title: "Key dates", items: ["Applications open: 27 July 2026", "Briefing sessions: 10 August & 24 August 2026, 11:00 AEST", "Applications close: Monday 14 September 2026, 17:00 AEST", "Winner notified: 21 September 2026", "Development period: 28 September вЂ“ 2 November 2026", "Launch: Monday 9 November 2026, 09:00 AEST"] },
    ],
  ...
  },
  {
    ...
    title: "Ceramics Now Annual 2026 вЂ” Featured Artist",
    deadline: "15 September 2026",
    deadlineDate: "2026-09-15",
    location: "International",
    audience: "Ceramic artists worldwide at any career stage; works made 2023 вЂ“ 2026 and at least 60% ceramic material",
    audiences: ["Individual artists"],
    ...
    sections: [
      ...
      { title: "Application", items: ["Non-refundable submission fee: $15 (supports the selection process and Annual production)", "Works must have been made between 2023 вЂ“ 2026 and be at least 60% ceramic material", "Deadline: 15 September 2026", "Selected artists announced 10 October 2026"] },
    ],
  ...
  },
  {
    ...
    title: "ROI Annual Exhibition 2026 вЂ” Open Submission",
    ...
    rewardSummary: "Prizes over ВЈ10,000",
    applicationFee: "See website",
    tags: ["OPEN CALL", "PAINTING", "OIL PAINTING", "LONDON"],
    intro: [
      "The Royal Institute of Oil Painters (founded 1882) invites artists to submit work for the ROI Annual Exhibition 2026 at Mall Galleries, London. The 2026 optional theme is 'Winter Rituals' вЂ” the traditions, gestures and rhythms that shape our experience of winter.",
      "Successful applicants have work shown in the gallery and online, become eligible for prizes and awards worth over ВЈ10,000, are invited to the Private View, and become part of a network of exhibiting artists dating back to 1882.",
    ],
    sections: [
      { title: "Selected prizes", items: ["The Roger Remington Award вЂ” ВЈ4,000", "Winsor & Newton Young Artist Award (age в‰¤ 30) вЂ” ВЈ1,000 / ВЈ600 / ВЈ400 in fine art materials", "The Peter Wileman Award вЂ” ВЈ500 for an imaginative work", "The ROI Themed Painting Prize вЂ” ВЈ500 for the standout 'Winter Rituals' work", "Numerous additional prizes, medals and certificates of commendation"] },
      { title: "Key dates", items: ["Submissions open: Monday 8 June 2026, 12:00", "Submissions close: Friday 9 October 2026, 12:00", "Notification of selection: Friday 23 October 2026, 12:00", "Receiving Day (if selected): Saturday 14 November 2026", "Private View: Wednesday 25 November 2026", "Exhibition: Thursday 26 November вЂ“ Saturday 12 December 2026"] },
